...
def save_datasets_to_pickle(datasets, paths=None):
    ...
    if paths == None:
        import root
        paths = [
            root.DIR_DATA_STAGE + 'exog_df.pkl',
        ]
...
def main():
    ...
    variables_temp = temperature_features(datos)
    ...
    # Merge datasets
    df_final = merge_df(datos,variables_exogenas, exog_features)
    
    # Save datasets
    save_datasets_to_pickle([df_final])
